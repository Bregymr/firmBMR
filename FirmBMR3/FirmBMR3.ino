...
#define PIN_DIR A0
#define PIN_PULSE A1
#define PIN_ENABLED A2
#define PIN_QUEQUE 6
#define PIN_FIN_DE_CARRERA_A 2
#define PIN_FIN_DE_CARRERA_B 3


#define PASOS_POR_MILIMETRO 100.0
#define GRADOS_POR_PASO 1.8
#define VELOCIDAD_MAXIMA 500.0 //mm/s
...
#else
  float posicionValue = 0.0;   //   mm
  float velocidadValue = 50.0;//   mm/s
  float aceleracionValue = 0.0;//   mm/s2
  float anguloValue = 0.0;
  int errorValue = 0;
